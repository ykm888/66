...
# 禁用 EOF，专注于 1024M 适配与 Error 255 根治

CONFIG_FILE=".config"

echo "⚙️ 1. 内核与驱动优化 (用户指令对齐)..."
# 启用 mt7981-wo-firmware
...
grep -q "CONFIG_PACKAGE_dnsmasq-full=y" $CONFIG_FILE || echo "CONFIG_PACKAGE_dnsmasq-full=y" >> $CONFIG_FILE

echo "🧠 3. 注入 SL-3000 1024M 物理设备定义..."
