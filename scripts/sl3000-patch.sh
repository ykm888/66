...
# 1. Physical Memory Lock (Ensuring all Mediatek devices recognize 1024M)
...
# 3. Kernel Header Fix (Fixing MTK Ethernet SOC definitions for Kernel 6.6)
